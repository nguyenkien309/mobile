...
import { StyleSheet,div, Text, View, TouchableOpacity, ImageBackground } from 'react-native';
...
const DateTime = ({current, lat, lon, timezone, hourly}) => {
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.rightAlign}>
                ...
                <Text style={styles.latlong}>{lat} - {lon}</Text>
            </View>
        </View>
    )
}
